        ...
        @if($frontends)
            @foreach($frontends as $frontend)
                <tr>
                    ...
                    <td><a class="text-decoration-none text-dark" href="{{route('frontend.show', $frontend->id)}}">{{$frontend->description ? Str::limit($frontend->description, 150) : 'No Description'}}</a></td>
