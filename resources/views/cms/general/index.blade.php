...
@section('content')
    ...
    <h1 class="my-4"><span class="badge badge-warning text-white display-1 shadow text-uppercase">General Data</span></h1>
        ...
        @if($generals)
            @foreach($generals as $general)
                <tr>
                    ...
                    <td><a class="text-decoration-none text-dark" href="{{route('general.show', $general->id)}}">{{$general->description ? Str::limit($general->description, 150) : 'No Description'}}</a></td>
